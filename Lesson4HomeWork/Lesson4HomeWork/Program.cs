...
namespace Lesson4HomeWork
{
    internal class Program
    {
        ...
        //    }
            ...
            //string[] namesArray = { "Иван", "Андрей", "Яков", "Юрий", "Татьяна", "Мария", "Авдотья", "Елизавета" };

            //// сортировка вставками
            //var len = namesArray.Length;
            //for (var i = 0; i < namesArray.Length; i++)
            //{
            //    var key = namesArray[i];
            //    var j = i;
            //    while ((j > 1) && (namesArray[j - 1].CompareTo(key) > 0))
            //    {
            //        var temp = namesArray[j - 1];
